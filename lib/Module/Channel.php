...
class Channel extends \OpenTHC\Module\Base
{
	/**
	 *
	 */
	function __invoke($a)
	{
		...
		// Single
		$a->get('/{id}.json', 'OpenTHC\Directory\Controller\Channel\Single');
		$a->get('/{id}', 'OpenTHC\Directory\Controller\Channel\Single');
